...
<h-row :gutter="20">
  <h-col :span="6"><div class="grid-content bg-purple"></div></h-col>
  <h-col :span="6" :offset="6"><div class="grid-content bg-purple"></div></h-col>
</h-row>
<h-row :gutter="20">
  <h-col :span="6" :offset="6"><div class="grid-content bg-purple"></div></h-col>
  <h-col :span="6" :offset="6"><div class="grid-content bg-purple"></div></h-col>
...
<h-row :gutter="20">
  <h-col :span="12" :offset="6"><div class="grid-content bg-purple"></div></h-col>
</h-row>
...
<h-row :gutter="10">
  ...
  <h-col :xs="4" :sm="6" :md="8" :lg="9" :xl="11"><div class="grid-content bg-purple-light"></div></h-col>
  <h-col :xs="4" :sm="6" :md="8" :lg="9" :xl="11"><div class="grid-content bg-purple"></div></h-col>
  <h-col :xs="8" :sm="6" :md="4" :lg="3" :xl="1"><div class="grid-content bg-purple-light"></div></h-col>
</h-row>
